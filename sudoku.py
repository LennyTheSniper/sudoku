...
textetimer = tk.StringVar(racine, "Votre temps s'affichera ici en fin de partie")
...
racine.bind('<ampersand>', un)
racine.bind('<eacute>', deux)
racine.bind('"', trois)
racine.bind("'", quatre)
racine.bind('(', cinq)
racine.bind('-', six)
racine.bind('<egrave>', sept)
racine.bind('_', huit)
racine.bind('<ccedilla>', neuf)
racine.bind('<agrave>', effacer)
grille()
texte()
racine.mainloop()
